...
$conn = mysqli_connect("localhost:3306", "root", "", "db_wad_modul3");
// 
...
$query = mysqli_query ($connect, "INSERT INTO showroom_mobil(id, nama_mobil, brand_mobil, warna_mobil, tipe_mobil, harga_mobil)
VALUES ('$id', '$nama_mobil', '$brand_mobil', '$warna_mobil', '$tipe_mobil', '$harga_mobil')");
